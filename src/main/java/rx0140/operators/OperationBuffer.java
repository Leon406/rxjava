...
public final class OperationBuffer extends ChunkedOperation {
     ...
     * values from the specified {@link Observable} source and stores them in a buffer until the {@link Observable} constructed using the {@link Func0} argument, produces a {@link Closing}
     ...
     * 
     * <p>Chunks can be created by pushing a {@link Opening} value to the "bufferOpenings" {@link Observable}.
     ...
     * {@link Observable} which can produce {@link Closing} values. When it does so it will close this (and only this) newly created
     ...
     *            An {@link Observable} which when it produces a {@link Opening} value will
