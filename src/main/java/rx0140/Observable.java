...
import rx0140.concurrency.Schedulers;
import rx0140.observables.BlockingObservable;
import rx0140.observables.ConnectableObservable;
import rx0140.observables.GroupedObservable;
import rx0140.operators.OperationAll;
import rx0140.operators.OperationAny;
import rx0140.operators.OperationAverage;
import rx0140.operators.OperationBuffer;
import rx0140.operators.OperationCache;
import rx0140.operators.OperationCombineLatest;
import rx0140.operators.OperationConcat;
import rx0140.operators.OperationDebounce;
import rx0140.operators.OperationDefer;
import rx0140.operators.OperationDematerialize;
import rx0140.operators.OperationDistinct;
import rx0140.operators.OperationDistinctUntilChanged;
import rx0140.operators.OperationElementAt;
import rx0140.operators.OperationFilter;
import rx0140.operators.OperationFinally;
import rx0140.operators.OperationFirstOrDefault;
import rx0140.operators.OperationGroupBy;
import rx0140.operators.OperationInterval;
import rx0140.operators.OperationMap;
import rx0140.operators.OperationMaterialize;
import rx0140.operators.OperationMerge;
import rx0140.operators.OperationMergeDelayError;
import rx0140.operators.OperationMulticast;
import rx0140.operators.OperationObserveOn;
import rx0140.operators.OperationOnErrorResumeNextViaFunction;
import rx0140.operators.OperationOnErrorResumeNextViaObservable;
import rx0140.operators.OperationOnErrorReturn;
import rx0140.operators.OperationOnExceptionResumeNextViaObservable;
import rx0140.operators.OperationParallel;
import rx0140.operators.OperationRetry;
import rx0140.operators.OperationSample;
import rx0140.operators.OperationScan;
import rx0140.operators.OperationSkip;
import rx0140.operators.OperationSkipWhile;
import rx0140.operators.OperationSubscribeOn;
import rx0140.operators.OperationSum;
import rx0140.operators.OperationSwitch;
import rx0140.operators.OperationSynchronize;
import rx0140.operators.OperationTake;
import rx0140.operators.OperationTakeLast;
import rx0140.operators.OperationTakeUntil;
import rx0140.operators.OperationTakeWhile;
import rx0140.operators.OperationThrottleFirst;
import rx0140.operators.OperationTimestamp;
import rx0140.operators.OperationToObservableFuture;
import rx0140.operators.OperationToObservableIterable;
import rx0140.operators.OperationToObservableList;
import rx0140.operators.OperationToObservableSortedList;
import rx0140.operators.OperationWindow;
import rx0140.operators.OperationZip;
import rx0140.operators.SafeObservableSubscription;
import rx0140.operators.SafeObserver;
import rx0140.plugins.RxJavaErrorHandler;
import rx0140.plugins.RxJavaObservableExecutionHook;
import rx0140.plugins.RxJavaPlugins;
import rx0140.subjects.PublishSubject;
import rx0140.subjects.ReplaySubject;
import rx0140.subjects.Subject;
import rx0140.subscriptions.Subscriptions;
import rx0140.util.Closing;
import rx0140.util.OnErrorNotImplementedException;
import rx0140.util.Opening;
import rx0140.util.Range;
import rx0140.util.Timestamped;
...
import rx0140.util.functions.Func3;
import rx0140.util.functions.Func4;
import rx0140.util.functions.Func5;
import rx0140.util.functions.Func6;
import rx0140.util.functions.Func7;
import rx0140.util.functions.Func8;
import rx0140.util.functions.Func9;
import rx0140.util.functions.FuncN;
import rx0140.util.functions.Function;
...
public class Observable<T> {
     ...
     * <p>
     * This is similar to the {@link #from(Object[])} method, except that
     ...
     * emitted and replaced with a new buffer when the Observable produced by the specified {@link Func0} produces a {@link Closing} object. The * {@link Func0} will then
     ...
     *            When this {@link Observable} produces a {@link Closing} object, the associated buffer
     ...
     *         when the current {@link Observable} created with the {@link Func0} argument produces a {@link Closing} object.
     */
     ...
     * Observable produces a {@link Opening} object. Additionally the {@link Func0} argument
     * is used to create an Observable which produces {@link Closing} objects. When this
     * Observable produces such an object, the associated buffer is emitted.
     * 
     * @param bufferOpenings
     *            The {@link Observable} which, when it produces a {@link Opening} object, will cause
     ...
     * Observable produced by the specified {@link Func0} produces a {@link Closing} object. The {@link Func0} will then be used to create a new Observable to listen for the end of the next
     * window.
     * <p>
     ...
     *            When this {@link Observable} produces a {@link Closing} object, the associated window
     *            is emitted and replaced with a new one.
     * @return
     ...
     * Chunks are created when the specified "windowOpenings" Observable produces a {@link Opening} object.
     * Additionally the {@link Func0} argument is used to create an Observable which produces {@link Closing} objects. When this Observable produces such an object, the associated window is
     * emitted.
     * <p>
    ...
    /**
     * Instruct an Observable to pass control to another Observable rather than invoking {@link Observer#onError onError} if it encounters an error of type {@link Exception}.
     * <p>
