...
public class ChunkedOperation {
    ...
    protected static class Chunks<T, C> {
        ...
        /**
         * Constructs a new {@link Chunks} object for the specified {@link rx0160.Observer}.
         * 
         * @param observer
         *            The {@link rx0160.Observer} to which this object will emit its internal {@link Chunk} objects to when requested.
         */
     ...
     * a {@link rx0160.Observer} object, and a {@link ChunkCreator} object. The {@link ChunkCreator} will manage the creation, and in some rare
     ...
     * object from the provided {@link rx0160.Observable} created with the
     ...
     * an object from the provided chunkOpenings {@link rx0160.Observable}, and closes the corresponding {@link Chunk} object when it receives an object from the provided
     * {@link rx0160.Observable} created
