 ...
 * 
 * @deprecated Use {@link rx0160.schedulers.Schedulers} instead. This will be removed before 1.0 release.
 */
@Deprecated
public class Schedulers {
    ...
    public static Scheduler immediate() {
        return rx0160.schedulers.ImmediateScheduler.getInstance();
    }
    ...
    public static Scheduler currentThread() {
        return rx0160.schedulers.CurrentThreadScheduler.getInstance();
    }
    ...
    public static Scheduler newThread() {
        return rx0160.schedulers.NewThreadScheduler.getInstance();
    }
    ...
    public static Scheduler executor(Executor executor) {
        return new rx0160.schedulers.ExecutorScheduler(executor);
    }
    ...
    public static Scheduler threadPoolForComputation() {
        return rx0160.schedulers.Schedulers.threadPoolForComputation();
    }
    ...
    public static Scheduler threadPoolForIO() {
        return rx0160.schedulers.Schedulers.threadPoolForIO();
    }
