 ...
 * 
 * @deprecated Use {@link rx0160.schedulers.ImmediateScheduler} instead. This will be removed before 1.0 release.
 */
@Deprecated
public class ImmediateScheduler extends Scheduler {
    ...
    private final rx0160.schedulers.ImmediateScheduler actual;

    private ImmediateScheduler() {
        actual = rx0160.schedulers.ImmediateScheduler.getInstance();
    }
