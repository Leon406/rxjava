 ...
 * 
 * @deprecated Use {@link rx0160.schedulers.CurrentThreadScheduler} instead. This will be removed before 1.0 release.
 */
@Deprecated
public class CurrentThreadScheduler extends Scheduler {
    ...
    private final rx0160.schedulers.CurrentThreadScheduler actual;

    private CurrentThreadScheduler() {
        actual = rx0160.schedulers.CurrentThreadScheduler.getInstance();
    }
