 ...
 * to allow reactive processing and composition can implement the {@link rx0200.Observable} interface which then allows Observers to subscribe to them
 * and receive events.</p>
 * <p>Usage examples can be found on the {@link rx0200.Observable} and {@link rx0200.Subscriber} classes.</p>
 */
package rx0200;
