...
public abstract class RxJavaDefaultSchedulers {
    ...
    /**
     * Scheduler to return from {@link rx0200.schedulers.Schedulers#computation()} or null if default should be
     * used.
     * 
    ...
    /**
     * Scheduler to return from {@link rx0200.schedulers.Schedulers#io()} or null if default should be used.
     * 
     * This instance should be or behave like a stateless singleton;
     */
    ...
    /**
     * Scheduler to return from {@link rx0200.schedulers.Schedulers#newThread()} or null if default should be used.
     * 
     * This instance should be or behave like a stateless singleton;
     */
