...
public abstract class RxJavaObservableExecutionHook {
    ...
    /**
     * Invoked before {@link Observable#subscribe(rx0200.Subscriber)} is about to be executed.
     * <p>
     * This can be used to decorate or replace the <code>onSubscribe</code> function or just perform extra
     * logging, metrics and other such things and pass-thru the function.
     * 
    ...
    /**
     * Invoked after successful execution of {@link Observable#subscribe(rx0200.Subscriber)} with returned
     * {@link Subscription}.
     * <p>
